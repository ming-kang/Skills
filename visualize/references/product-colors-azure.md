...
> **House style first.** These colors are mostly cold and will trip the warm-palette validator if overused. Limit to 1–2 Azure badges per figure; keep everything else in the warm family palette from `references/style.md`.
...
For diagrams that need a recognizable "Azure" visual without a service badge — e.g. a region container or a subscription boundary — use a dashed Azure-blue outline:
...
<text x="x+12" y="y+16" fill="#0089D6" font-size="10"
      font-weight="700" letter-spacing="0.06em">Azure • East US</text>
```
